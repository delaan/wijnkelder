        ...
        <div className="aspect-[4/5] bg-surface-2 relative overflow-hidden flex items-center justify-center">
          ...
          {onToggleFavorite && (
            <button
              ...
              className="absolute top-2.5 right-2.5 w-9 h-9 rounded-token-full bg-surface/90 backdrop-blur flex items-center justify-center text-accent shadow-token-sm"
            >
