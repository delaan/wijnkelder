  ...
  return (
    <div className="min-h-screen bg-bg flex flex-col">
      ...
      <div className="flex-1 flex min-w-0">
        ...
        <main className="flex-1 min-w-0 px-4 sm:px-6 py-6 pb-48 md:pb-32 max-w-6xl w-full mx-auto">{children}</main>
      </div>

      <BottomNav view={view} onNavigate={onNavigate} onAdd={onAdd} />
    </div>
  )
}
